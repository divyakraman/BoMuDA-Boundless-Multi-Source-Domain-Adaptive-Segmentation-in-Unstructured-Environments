...
IGNORE_LABEL = 255
INPUT_SIZE_TARGET = '839,484' 
LEARNING_RATE = 2.5e-4
MOMENTUM = 0.9
NUM_CLASSES = 19
NUM_STEPS = 90000
NUM_STEPS_STOP = 90000  
POWER = 0.9
RANDOM_SEED = 1234
...
def main():
    ...
    # Create network
    #model = DRNSeg()
    model = torch.load('snapshots/bddbase_multi3source_refinedbddfromiter3labels_drnd38_iteration4/IDD_30000.pth')
    ...
    model_D1 = torch.load('snapshots/bddbase_multi3source_refinedbddfromiter3labels_drnd38_iteration4/IDD_30000_D1.pth')
    model_D2 = torch.load('snapshots/bddbase_multi3source_refinedbddfromiter3labels_drnd38_iteration4/IDD_30000_D2.pth')
    ...
    for i_iter in range(0, args.num_steps):
        ...
        if i_iter >= args.num_steps_stop - 1:
            print('save model ...')
            torch.save(model, osp.join(args.snapshot_dir, 'BDD_' + str(args.num_steps_stop) + '.pth'))
            torch.save(model_D1, osp.join(args.snapshot_dir, 'BDD_' + str(args.num_steps_stop) + '_D1.pth'))
            torch.save(model_D2, osp.join(args.snapshot_dir, 'BDD_' + str(args.num_steps_stop) + '_D2.pth'))
            break
